...
int main(int argc,char *argv[])
{
 ...
 Fecha f1(16,8,2021); /*16 de agosto de 2021 */
 Fecha f2(18,12,2021); /*18 de diciembre de 2021*/
 ...
 vector<Dia*> vdnl;
 vdnl.push_back(new Dia(new Fecha(16,9,2021)));/*16 septiembre 2021*/
 vdnl.push_back(new Dia(new Fecha(1,11,2021)));/*1 noviembre 2021*/
 vdnl.push_back(new Dia(new Fecha(2,11,2021)));/*2 noviembre 2021*/
 vdnl.push_back(new Dia(new Fecha(15,11,2021)));/*15 noviembre 2021*/
