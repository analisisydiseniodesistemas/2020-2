...
/**Following 6 lines are not needed anymore and on a future commit 
 * will be deleted.  Thursday 2020.01.30*/
//Calendario *Cal_Greg;
//int anio=2020;
...
main(int argc,char *argv[])
{
   ...
   * error in file ../CommonFiles/Calendario.cpp.       2020.01.28*/
  Calendario *Cal_Greg=new Calendario(2020);    /*Calendario Gregoriano*/
